...
| **Professional or employment info** | Work patterns, productivity metrics (agent-captured metadata); job title, department, employment type, hire date (employer-provided via IdP/CSV) |
