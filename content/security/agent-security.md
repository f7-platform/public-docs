...
Telemetry uploads are signed with a per-device HMAC key issued at enrollment and stored in the operating system keychain. The controller verifies the signature over the exact compressed request body before accepting telemetry.
