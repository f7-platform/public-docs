...
- Public audit references now use Run 38 as the latest security audit baseline.
- Claims registry updated to Run 38 and now registers material integration provider, Mode 3 capture, and Trust Center dependency-audit claims.
